...
-- Select the SQL code for both tables and copy it into table plus, then in table plus, select all the code and run current so that it creates them together.
```
